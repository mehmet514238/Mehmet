...
\x1b[1mHepinize çok teşşekkür ederim. ♥
    \x1b[0m
        Merhaba, benim adım Mehmet ve aracımı kullandığınız için tesekkür ederim.
...
export async function collectData(data) {
    ...
    if(JSON.stringify(data) == "{}") {
        const res = await getResult(
            ...
            `Telif Hakkı 2023 © Mehmet. Tüm hakları saklıdır.
            Mehmet Kanalından Sevgiyle ve ❤️ ile.
